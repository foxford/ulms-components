...
export class ShapeTool extends PositionableObject {
  ...
  _reshape () {
    ...
    if (
      ...
      if (this.__object.type === 'circle' || this.__object.type === 'WhiteboardCircle') {
        ...
        || this.__object.type === 'WhiteboardStar'
      ) {
  ...
  handleKeyDownEvent (e) {
    const changed = this.__shiftPressed !== e.shiftKey || this.__altPressed !== e.altKey
  ...
  handleMouseMoveEvent (opts) {
    ...
    this.__currentPoint = this._canvas.getPointer(opts.e)
    this._reshape()
  }
